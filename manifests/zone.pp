...
define bind::zone (
  ...
  Pattern['^\d+$']         $zone_ttl        = undef,
  Pattern['^\S+$']         $zone_contact    = undef,
  Pattern['^\d+$']         $zone_serial     = undef,
  String                   $zone_refresh    = '3h',
  String                   $zone_retry      = '1h',
  String                   $zone_expiracy   = '1w',
  Array                    $zone_ns         = [],
  Optional[String]         $zone_xfers      = undef,
  Optional[String]         $zone_masters    = undef,
  Optional[String]         $zone_forwarders = undef,
